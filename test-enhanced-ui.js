...
test('AI analysis has evidence chains', () => {
  ...
  assertContains(content, 'evidenceChain', 'Evidence chains missing');
  assertContains(content, 'source', 'Citation system missing');
  assertContains(content, 'confidence', 'Confidence scoring missing');
  assertContains(content, 'multimodal', 'Multimodal analysis missing');
});
